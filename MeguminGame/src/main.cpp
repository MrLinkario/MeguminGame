...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	//Shrek
	shrekModelAnimate.loadModel("../models/Megumin6/megumin.fbx");
...
void applicationLoop() {
	...
	//Posicion light, apuntador a la camara, distancia maxuma de alcance, plano cercano y el FOV(Field Of View)
...
void renderScene(bool renderParticles){
	...
	modelMatrixShrekBody = glm::scale(modelMatrixShrekBody, glm::vec3(1.0, 1.0, 1.0));
	//shrekModelAnimate.setAnimationIndex(0);
